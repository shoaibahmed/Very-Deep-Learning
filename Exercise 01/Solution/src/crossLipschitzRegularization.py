...
parser.add_option("--regularizationLambda", action="store", type="float", dest="regularizationLambda", default=10, help="Lambda to be used for Lipschitz regularization")
...
with tf.name_scope('Loss'):
	...
	# Add cross lipschitz regularization parameter
	# Compute the gradients first
	grads = tf.gradients()
	lipschitz_regularization_loss = 2.0 / [options.numTestInstances * (options.numClasses**2)] * grads
